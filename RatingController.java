...
public class RatingController {
    ...
    @PostMapping // This posts the rating into the database.
    ...
    @GetMapping("/{id}") // Rating is fetched using id.
    ...
    @GetMapping("/user/{userId}") // Rating is fetched using userid.
    ...
    @GetMapping("/driver/{driverId}") // Rating is fetched using driverid.
