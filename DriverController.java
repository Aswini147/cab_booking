...
public class DriverController {
    ...
    @GetMapping("/{id}") // This is used to get the driver details using the id
    ...
    @GetMapping // To get the list of all the drivers
    ...
    @GetMapping("/{id}/status") // To get driver status using driver id
    ...
    @PutMapping("/{id}/status") // To update the driver status.
    ...
    @PutMapping("/{id}") // To update the driver profile.
    ...
    @PostMapping // Creates a new resource for the new driver registration.
